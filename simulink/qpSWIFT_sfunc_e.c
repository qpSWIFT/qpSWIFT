...
#define S_FUNCTION_NAME qpSWIFT_sfunc_e /**< Name of the S function. */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    qp_real sigma_d;
    qp_int idx;
    qp_int size_P, size_c, size_A, size_b, size_G, size_h, size_sigma_d;
    ...
    InputRealPtrsType in_P, in_c, in_A, in_b, in_G, in_h;
    ...
    size_A = ssGetInputPortWidth(S, 2); // A
    size_b = ssGetInputPortWidth(S, 3); // b
    size_G = ssGetInputPortWidth(S, 4); // G
    size_h = ssGetInputPortWidth(S, 5); // h
